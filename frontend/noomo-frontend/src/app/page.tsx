    ...
    <div className="min-h-screen w-full flex flex-col">
      ...
      <header className="w-full flex items-center justify-center px-6 py-4">
        <nav className="flex items-center gap-4">
          <a href="https://github.com/skueee/noomo" target="_blank" rel="noopener noreferrer" className="hover:underline kalnia-main text-[22px]">Source</a>
          <a href="https://stardance.hackclub.com/projects/52704" target="_blank" rel="noopener noreferrer" className="hover:underline kalnia-main text-[22px]">Stardance</a>
        </nav>
      </header>
        ...
        <div className="flex flex-col items-center gap-5 max-w-md w-full p-0">
          ...
          <div className="flex flex-col items-center gap-3 max-w-md w-full p-0">
            ...
            <div className="challenge-rect flex flex-row px-3 w-[500px] h-[54px]">
              <label className="kalnia-main text-[32px] text-background w-full h-full">Daily challenge</label>
